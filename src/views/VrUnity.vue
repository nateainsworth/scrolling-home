...
const createWith = [ 'Vue.js', 'Node.js', 'Unity 3D', 'Chart.js', 'Blender', 'Bootstrap', 'C#', 'MySQL'];
  ...
  <div ref="page" class='page-box' :class="{'drag-view': props.isDragging}" v-if="props.activePage == props.pageName || props.isDragging">
    <div class='page-main'>
      <div class="title-area">
        <h2>VR Health Application V1</h2>
        <p>Built on Unity3D</p>
      </div>
    </div>
...
.page-main::before{
  ...
  top:0;
  left:0;
  background: url('https://github.com/nateainsworth/scrolling-home/blob/main/src/assets/MagicalForest.png?raw=true');
